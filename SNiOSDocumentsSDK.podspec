...
Pod::Spec.new do |spec|
  ...
  spec.ios.vendored_frameworks = '{spec.version}/SNiOSDocumentsSDK.xcframework'
  spec.source       = { :http => 'https://github.com/SignNowInc/SN_iOS_SDK/archive/refs/tags/0.2.1.zip' }
